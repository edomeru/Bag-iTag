...
class TKTCoreLocation: NSObject, CLLocationManagerDelegate, CBPeripheralManagerDelegate {
    ...
    func stopAdvertising() {
        Globals.log("Stop Advertising \(activatedBeaconUUID)")
    ...
    func locationManager(_ manager: CLLocationManager, didDetermineState state: CLRegionState, for region: CLRegion) {
        ...
        case CLRegionState.inside:
            Globals.log(" - entered region spot \(region)")
        ...
        case CLRegionState.outside:
            Globals.log(" - exited region \(region)")
        ...
        default:
            Globals.log(" - unknown region \(region)")
        }
    }
